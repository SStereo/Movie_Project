...
interstellar = media.Movie(
    "Interstellar",
    "A father rescures humanity during a space mission",
...
gladiator = media.Movie(
    "Gladiator",
    "A soldier fights to free rome",
    "https://upload.wikimedia.org/wikipedia/en/thumb/8/8d/Gladiator_ver1.jpg/220px-Gladiator_ver1.jpg",  # NOQA
    "https://www.youtube.com/watch?v=owK1qxDselE"
    )

sunshine = media.Movie(
    "Sunshine",
    "A space crew saves our sun",
    "https://upload.wikimedia.org/wikipedia/en/thumb/6/68/Sunshine_poster.jpg/220px-Sunshine_poster.jpg",  # NOQA
